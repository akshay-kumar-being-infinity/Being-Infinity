    ...
    <div className="relative min-h-screen w-full flex items-center justify-center bg-bg-dark overflow-hidden font-sans text-text-primary selection:bg-primary-light selection:text-bg-dark">
      <div className="relative w-full max-w-md p-8 bg-bg-surface border border-border rounded-2xl">
        ...
        <div className="space-y-4">
          {/* ✅ REPLACE button content ONLY - GIS renders inside div */}
          <div ref={googleButtonRef}
            className="group w-full flex items-center justify-center cursor-pointer gap-3 bg-bg-elevated hover:bg-bg-elevated/80 border border-border hover:border-primary-light/50 text-text-primary font-medium py-3.5 px-4 rounded-xl transition-all duration-300 ease-in-out relative overflow-hidden">
            {/* Fallback SVG if GIS fails to load */}
